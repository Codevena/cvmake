...
import { bauhaus } from '../src/bauhaus/index.js';

const palette = bauhaus.palettes[0];
if (!palette) throw new Error('bauhaus palette[0] missing');

describe('BauhausTemplate', () => {
  ...
  it('zeigt Initialen wenn kein Foto', () => {
    ...
    expect(html).toMatch(/bauhaus__initials[^>]*>LB/);
  });
